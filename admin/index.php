        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="index.php?halaman=todolistdaftar" class="nav-link "><span class="pcoded-micon"><i class="feather icon-sidebar"></i></span><span class="pcoded-mtext">Data To Do List</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <main>
            ...
            if (isset($_GET['halaman'])) {
                if ($_GET['halaman'] == "beranda") {
                    ...
                    include 'logout.php';
                } elseif ($_GET['halaman'] == "todolistdaftar") {
                    include 'todolistdaftar.php';
                } elseif ($_GET['halaman'] == "todolisttambah") {
                    include 'todolisttambah.php';
                } elseif ($_GET['halaman'] == "todolisthapus") {
                    include 'todolisthapus.php';
                } elseif ($_GET['halaman'] == "todolistedit") {
